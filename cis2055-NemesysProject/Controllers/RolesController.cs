...
namespace cis2055_NemesysProject.Controllers
{
    public class RolesController : Controller
    {
        ...
        public RolesController(NemesysContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Role_ID,RoleType")] Roles roles)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Role_ID,RoleType")] Roles roles)
        {
            if (id != roles.Role_ID)
            {
                return NotFound();
